...
public class SpellChecker extends JFrame implements ActionListener,KeyListener,ListSelectionListener {
	...
	public SpellChecker() {
		...
		this.textArea.setFont(new Font("Bradley Hand ITC", Font.BOLD, 16)); // set a default font for the TextArea
		this.textArea.setEditable(true);
		this.textArea.addKeyListener(this);
		this.getContentPane().add(textArea).setBounds(0,0,700,600);
		
		this.getContentPane().add(list).setBounds(710,60,263,400);
		
		this.label.setText("SUGGESTIONS [ click to replace ]");
		this.label.setFont(new Font("Bradley Hand ITC", Font.BOLD, 14));
	...
	public void actionPerformed (ActionEvent e) {
		...
		if(e.getSource() == this.newFile)
			...
			this.textArea.setFont(new Font("Bradley Hand ITC", Font.BOLD, 16));
		
		else if (e.getSource() == this.italic)
			this.textArea.setFont(new Font("Bradley Hand ITC", Font.ITALIC, 16));
